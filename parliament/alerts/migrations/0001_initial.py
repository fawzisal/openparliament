    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('politician', models.ForeignKey(to='core.Politician', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='SeenItem',
        ...
        migrations.AddField(
            ...
            name='topic',
            field=models.ForeignKey(to='alerts.Topic', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='subscription',
            name='user',
            field=models.ForeignKey(to='accounts.User', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='seenitem',
            name='topic',
