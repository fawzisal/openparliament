    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(to='hansards.Document', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Statement',
            fields=[
                ...
                ('document', models.ForeignKey(to='hansards.Document', on_delete=models.CASCADE)),
                ('member', models.ForeignKey(blank=True, to='core.ElectedMember', null=True, on_delete=models.CASCADE)),
                ('mentioned_politicians', models.ManyToManyField(related_name='statements_with_mentions', to='core.Politician', blank=True)),
                ('politician', models.ForeignKey(blank=True, to='core.Politician', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('sequence',),
            },
